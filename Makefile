...
clean:
	rm -f pipper fauth smtpEnum params massftpanon smbrute *.exe
	
uninstall:
	rm -f /usr/bin/pipper /usr/bin/fauth /usr/bin/smtpEnum /usr/bin/smbrute /usr/bin/params /usr/bin/massftpanon

install:
	cp pipper fauth smtpEnum params massftpanon smbrute /usr/bin/
